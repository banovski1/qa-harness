---
description: >-
  Analyzes a pasted numbered test script to separate precondition/test-data
  setup from the actual UI journey under test, then hands an enhanced prompt to
  test-writer. Runs automatically before test-writer on every pasted numbered
  script.
mode: subagent
