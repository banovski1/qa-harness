...
name: framework
description: >-
  Build the test framework from an approved draft and prove it compiles and runs
  — generate, install, typecheck, smoke. Use for "/framework", "generate the
  framework", "build the tests", "does the framework compile", "the draft is
  approved". Runs after /setup.
---
