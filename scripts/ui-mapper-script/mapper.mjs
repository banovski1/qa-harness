...
//
// Given a login flow as parameters (see scripts/ui-mapper-script/app-map-config.yaml) — entry URL,
...
async function main() {
  const specPath = process.argv[2] ?? join('scripts', 'ui-mapper-script', 'app-map-config.yaml');
