...
name: setup
description: >-
  Use for "/setup", "set this up", "analyse my app", "get me started" — runs the
  whole pipeline end to end from a filled-in .env, installing what is missing
  and stopping with a specific fix when something is wrong.
---
# setup
