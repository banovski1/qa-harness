...
name: app-dossier
description: >-
  Read a local clone of the app under test and write down its stack and every
  route its source declares. Use for "what stack is this app", "list the app's
  routes", "regenerate the dossier", "analyse this repo". Runs first — the other
  analysis skills read its output.
---
# app-dossier
