...
name: app-worktree
description: >-
  Use when the user wants to analyse or test a second application — sets up a
  git worktree with its own .env and analysis.json, because the pipeline is
  one-app-per-checkout.
---
# app-worktree
