...
name: app-api
description: >-
  Document the API surface of a local clone of the app under test so
  preconditions and test data have real endpoints instead of guesses — including
  how a test user authenticates. Use for "what APIs does the app have",
  "document the API", "how do I log in via API", "regenerate the api section".
  Runs after app-dossier.
---
# app-api
