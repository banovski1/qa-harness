...
name: app-components
description: >-
  Read a local clone of the app under test and write down its component
  conventions — the UI library, how labels attach to controls, what a
  form/table/dialog looks like in this codebase. Use for "what components does
  the app use", "how are labels wired", "regenerate the conventions section".
