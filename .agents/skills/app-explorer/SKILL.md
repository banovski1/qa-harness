...
name: app-explorer
description: >-
  Document a running web application from its base URL alone — every screen, the
  components on it, a proved-unique locator for every control, and the API
  surface the app actually calls. Use for "analyse the app under test",
  "document this app", "build the locator strategy", "what screens does the app
  have", "regenerate ".
---
# app-explorer
