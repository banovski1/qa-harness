...
export class ViewSystemUsersPageGenerated extends BasePage {
  ...
  readonly typeForHints = new TextField(this.page, { label: 'Type for hints...' }, { screen: 'ViewSystemUsersPage', expectedUrl: '/web/index.php/admin/viewSystemUsers', modelPath: MODEL_PATH });
