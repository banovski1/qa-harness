...
export class AttachmentPageGenerated extends BasePage {
  readonly path = '/web/index.php/recruitment/viewInterviewAttachment/interview/{interviewId}/attachment/{attachmentId}';
