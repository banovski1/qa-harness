...
export class DisplayAttendanceSummaryReportCriteriaPageGenerated extends BasePage {
  readonly path = '/web/index.php/time/displayAttendanceSummaryReportCriteria';
