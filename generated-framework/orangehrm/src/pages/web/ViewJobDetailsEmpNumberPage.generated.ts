...
export class ViewJobDetailsEmpNumberPageGenerated extends BasePage {
  ...
  readonly yyyyDdMm = new TextField(this.page, { label: 'yyyy-dd-mm' }, { screen: 'ViewJobDetailsEmpNumberPage', expectedUrl: '/web/index.php/pim/viewJobDetails/empNumber/{empNumber}', modelPath: MODEL_PATH });
