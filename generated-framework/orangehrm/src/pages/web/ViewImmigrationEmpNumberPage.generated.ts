...
export class ViewImmigrationEmpNumberPageGenerated extends BasePage {
  ...
  readonly add = new Button(this.page, { label: 'Add' }, { screen: 'ViewImmigrationEmpNumberPage', expectedUrl: '/web/index.php/pim/viewImmigration/empNumber/{empNumber}', modelPath: MODEL_PATH });
  readonly add2 = new Button(this.page, { label: 'Add' }, { screen: 'ViewImmigrationEmpNumberPage', expectedUrl: '/web/index.php/pim/viewImmigration/empNumber/{empNumber}', modelPath: MODEL_PATH });
