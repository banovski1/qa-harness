...
export class WebIndexPhpPerformanceAddPerformanceTracker2PageGenerated extends BasePage {
  readonly path = '/web/index.php/performance/addPerformanceTracker/{id}';
