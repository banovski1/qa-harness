...
export class InventoryNumberPageGenerated extends BasePage {
  ...
  readonly all = new Button(this.page, { label: 'All' }, { screen: 'InventoryNumberPage', expectedUrl: '/#InventoryNumber', modelPath: MODEL_PATH });
  ...
  readonly control12040 = new Button(this.page, { label: '1–20 / 40' }, { screen: 'InventoryNumberPage', expectedUrl: '/#InventoryNumber', modelPath: MODEL_PATH });
  readonly previousPage = new Button(this.page, { label: 'Previous Page' }, { screen: 'InventoryNumberPage', expectedUrl: '/#InventoryNumber', modelPath: MODEL_PATH });
  readonly nextPage = new Button(this.page, { label: 'Next Page' }, { screen: 'InventoryNumberPage', expectedUrl: '/#InventoryNumber', modelPath: MODEL_PATH });
