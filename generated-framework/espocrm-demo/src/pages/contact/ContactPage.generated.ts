...
export class ContactPageGenerated extends BasePage {
  ...
  /** Proved by the crawl: this control leads to ContactCreatePage. */
  async goToCreateContact(): Promise<void> {
    await this.createContact.click();
    await this.page.waitForURL(url => url.href.includes('/#Contact/create'));
  }
