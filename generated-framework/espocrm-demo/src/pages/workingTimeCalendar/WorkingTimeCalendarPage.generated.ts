...
export class WorkingTimeCalendarPageGenerated extends BasePage {
  ...
  readonly control122 = new Button(this.page, { label: '1–2 / 2' }, { screen: 'WorkingTimeCalendarPage', expectedUrl: '/#WorkingTimeCalendar', modelPath: MODEL_PATH });
  readonly previousPage = new Button(this.page, { label: 'Previous Page' }, { screen: 'WorkingTimeCalendarPage', expectedUrl: '/#WorkingTimeCalendar', modelPath: MODEL_PATH });
  readonly nextPage = new Button(this.page, { label: 'Next Page' }, { screen: 'WorkingTimeCalendarPage', expectedUrl: '/#WorkingTimeCalendar', modelPath: MODEL_PATH });
