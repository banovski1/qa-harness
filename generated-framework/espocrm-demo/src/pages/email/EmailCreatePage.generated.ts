...
export class EmailCreatePageGenerated extends BasePage {
  ...
  readonly emails = new Link(this.page, { label: 'Emails' }, { screen: 'EmailCreatePage', expectedUrl: '/#Email/create', modelPath: MODEL_PATH });
  ...
  readonly from = new TextField(this.page, { field: 'from' }, { screen: 'EmailCreatePage', expectedUrl: '/#Email/create', modelPath: MODEL_PATH });
  readonly select = new TextField(this.page, { label: 'Select' }, { screen: 'EmailCreatePage', expectedUrl: '/#Email/create', modelPath: MODEL_PATH });
  readonly select2 = new Button(this.page, { label: 'Select' }, { screen: 'EmailCreatePage', expectedUrl: '/#Email/create', modelPath: MODEL_PATH });
  readonly select3 = new Button(this.page, { label: 'Select' }, { screen: 'EmailCreatePage', expectedUrl: '/#Email/create', modelPath: MODEL_PATH });
  readonly subject = new TextField(this.page, { field: 'subject' }, { screen: 'EmailCreatePage', expectedUrl: '/#Email/create', modelPath: MODEL_PATH });
  ...
  readonly table = new Button(this.page, { label: 'Table' }, { screen: 'EmailCreatePage', expectedUrl: '/#Email/create', modelPath: MODEL_PATH });
  ...
  readonly isHtml = new Checkbox(this.page, { field: 'isHtml' }, { screen: 'EmailCreatePage', expectedUrl: '/#Email/create', modelPath: MODEL_PATH });
  readonly select4 = new TextField(this.page, { label: 'Select' }, { screen: 'EmailCreatePage', expectedUrl: '/#Email/create', modelPath: MODEL_PATH });
  readonly select5 = new Button(this.page, { label: 'Select' }, { screen: 'EmailCreatePage', expectedUrl: '/#Email/create', modelPath: MODEL_PATH });
  ...
  /** Proved by the crawl: this control leads to EmailPage. */
  async goToEmails(): Promise<void> {
    await this.emails.click();
    await this.page.waitForURL(url => url.href.includes('/#Email'));
  }
