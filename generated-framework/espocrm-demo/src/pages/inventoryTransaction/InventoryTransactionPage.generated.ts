...
export class InventoryTransactionPageGenerated extends BasePage {
  ...
  readonly control120111 = new Button(this.page, { label: '1–20 / 111' }, { screen: 'InventoryTransactionPage', expectedUrl: '/#InventoryTransaction', modelPath: MODEL_PATH });
  readonly previousPage = new Button(this.page, { label: 'Previous Page' }, { screen: 'InventoryTransactionPage', expectedUrl: '/#InventoryTransaction', modelPath: MODEL_PATH });
  readonly nextPage = new Button(this.page, { label: 'Next Page' }, { screen: 'InventoryTransactionPage', expectedUrl: '/#InventoryTransaction', modelPath: MODEL_PATH });
