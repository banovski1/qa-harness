...
export class UserViewPageGenerated extends BasePage {
  ...
  readonly jackAdams = new RecordTable(this.page, 'jackAdams', { shape: TABLE_SHAPE, columns: [], keyColumn: null, screen: 'UserViewPage', expectedUrl: '/#User/view/{id}', modelPath: MODEL_PATH });
  readonly jackAdams2 = new RecordTable(this.page, 'jackAdams2', { shape: TABLE_SHAPE, columns: [], keyColumn: null, screen: 'UserViewPage', expectedUrl: '/#User/view/{id}', modelPath: MODEL_PATH });
  ...
  readonly jackAdams6 = new Link(this.page, { label: 'Jack Adams' }, { screen: 'UserViewPage', expectedUrl: '/#User/view/{id}', modelPath: MODEL_PATH });
  ...
  readonly jackAdams7 = new Link(this.page, { label: 'Jack Adams' }, { screen: 'UserViewPage', expectedUrl: '/#User/view/{id}', modelPath: MODEL_PATH });
