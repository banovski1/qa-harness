...
export class CallCreatePageGenerated extends BasePage {
  ...
  readonly name = new TextField(this.page, { label: 'Name *', via: 'proximity' }, { screen: 'CallCreatePage', expectedUrl: '/#Call/create', modelPath: MODEL_PATH });
  ...
  readonly description = new TextField(this.page, { label: 'Description', via: 'proximity' }, { screen: 'CallCreatePage', expectedUrl: '/#Call/create', modelPath: MODEL_PATH });
