...
export abstract class ReportToDetailsPageGenerated extends BasePage {
  ...
  get addSupervisorButton(): ButtonComponent {
    return new ButtonComponent(this.page.locator('.orangehrm-horizontal-padding:has(h6:text-is("Assigned Supervisors")) button'), 'Add Supervisor (button)');
  }

  /** Supervisor (table) */
  get supervisorTable(): TableComponent {
    return new TableComponent(this.page.locator('div:has(> .orangehrm-horizontal-padding:has(h6:text-is("Assigned Supervisors"))) > .orangehrm-container .oxd-table'), ['Name', 'Reporting Method', 'Actions'], 'Supervisor (table)');
  }
  ...
  get addSubordinateButton(): ButtonComponent {
    return new ButtonComponent(this.page.locator('.orangehrm-horizontal-padding:has(h6:text-is("Assigned Subordinates")) button'), 'Add Subordinate (button)');
  }

  /** Subordinate (table) */
  get subordinateTable(): TableComponent {
    return new TableComponent(this.page.locator('div:has(> .orangehrm-horizontal-padding:has(h6:text-is("Assigned Subordinates"))) > .orangehrm-container .oxd-table'), ['Name', 'Reporting Method', 'Actions'], 'Subordinate (table)');
  }
