...
export abstract class MembershipsPageGenerated extends BasePage {
  ...
  get addMembershipsButton(): ButtonComponent {
    return new ButtonComponent(this.page.locator('.orangehrm-horizontal-padding:has(h6:text-is("Assigned Memberships")) button'), 'Add Memberships (button)');
  }

  /** Assigned Memberships (table) */
  get assignedMembershipsTable(): TableComponent {
    return new TableComponent(this.page.locator('div:has(> .orangehrm-horizontal-padding:has(h6:text-is("Assigned Memberships"))) > .orangehrm-container .oxd-table'), ['Membership', 'Subscription Paid By', 'Subscription Amount', 'Currency', 'Subscription Commence Date', 'Subscription Renewal Date', 'Actions'], 'Assigned Memberships (table)');
  }
