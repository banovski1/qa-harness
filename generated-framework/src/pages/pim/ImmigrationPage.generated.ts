...
export abstract class ImmigrationPageGenerated extends BasePage {
  ...
  /** Add Immigration Records (button) */
  get addImmigrationRecordsButton(): ButtonComponent {
    return new ButtonComponent(this.page.locator('.orangehrm-horizontal-padding:has(h6:text-is("Assigned Immigration Records")) button'), 'Add Immigration Records (button)');
  }

  /** Assigned Immigration Records (table) */
  get assignedImmigrationRecordsTable(): TableComponent {
    return new TableComponent(this.page.locator('div:has(> .orangehrm-horizontal-padding:has(h6:text-is("Assigned Immigration Records"))) > .orangehrm-container .oxd-table'), ['Document', 'Number', 'Issued By', 'Issued Date', 'Expiry Date', 'Actions'], 'Assigned Immigration Records (table)');
  }
