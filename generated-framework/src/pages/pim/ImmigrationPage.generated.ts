...
// Source: web-index.php-pim-viewImmigration-empNumber-7
...
export abstract class ImmigrationPageGenerated extends BasePage {
  static readonly path = '/web/index.php/pim/viewImmigration/empNumber/7';
  ...
  /** Table (, Document, Number, Issued By, Issued Date, Expiry Date, Actions; 2 row(s)) (table) */
  // UNSTABLE: table has no accessible name; positional index used
  get tableTable(): TableComponent {
    return new TableComponent(this.page.getByRole('table').nth(0), ['', 'Document', 'Number', 'Issued By', 'Issued Date', 'Expiry Date', 'Actions'], 'Table (, Document, Number, Issued By, Issued Date, Expiry Date, Actions; 2 row(s)) (table)');
  }
  ...
  readonly contactDetailsOpen = new ImmigrationPageContactDetailsOpen(this.page);

  /** Elements revealed by opening 'Dependents'. Open the trigger first. */
  readonly dependentsOpen = new ImmigrationPageDependentsOpen(this.page);
}

/** Only present while 'Contact Details' is open. */
export class ImmigrationPageContactDetailsOpen {
...
export class ImmigrationPageDependentsOpen {
  constructor(private readonly page: Page) {}
