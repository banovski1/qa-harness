...
export abstract class EmergencyContactsPageGenerated extends BasePage {
  ...
  get addEmergencyContactsButton(): ButtonComponent {
    return new ButtonComponent(this.page.locator('.orangehrm-horizontal-padding:has(h6:text-is("Assigned Emergency Contacts")) button'), 'Add Emergency Contacts (button)');
  }

  /** Assigned Emergency Contacts (table) */
  get assignedEmergencyContactsTable(): TableComponent {
    return new TableComponent(this.page.locator('div:has(> .orangehrm-horizontal-padding:has(h6:text-is("Assigned Emergency Contacts"))) > .orangehrm-container .oxd-table'), ['Name', 'Relationship', 'Home Telephone', 'Mobile', 'Work Telephone', 'Actions'], 'Assigned Emergency Contacts (table)');
  }
