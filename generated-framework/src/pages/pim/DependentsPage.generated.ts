...
// Source: web-index.php-pim-viewDependents-empNumber-7
...
export abstract class DependentsPageGenerated extends BasePage {
  static readonly path = '/web/index.php/pim/viewDependents/empNumber/7';
  ...
  /** Table (, Name, Relationship, Date of Birth, Actions; 1 row(s)) (table) */
  // UNSTABLE: table has no accessible name; positional index used
  get tableTable(): TableComponent {
    return new TableComponent(this.page.getByRole('table').nth(0), ['', 'Name', 'Relationship', 'Date of Birth', 'Actions'], 'Table (, Name, Relationship, Date of Birth, Actions; 1 row(s)) (table)');
  }
