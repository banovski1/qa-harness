...
// Source: web-index.php-pim-viewSalaryList-empNumber-7
...
export abstract class SalaryListPageGenerated extends BasePage {
  static readonly path = '/web/index.php/pim/viewSalaryList/empNumber/7';
  ...
  /** Table (Salary Component, Amount, Currency, Pay Frequency, Direct Deposit Amount; 1 row(s)) (table) */
  // UNSTABLE: table has no accessible name; positional index used
  get tableTable(): TableComponent {
    return new TableComponent(this.page.getByRole('table').nth(0), ['Salary Component', 'Amount', 'Currency', 'Pay Frequency', 'Direct Deposit Amount'], 'Table (Salary Component, Amount, Currency, Pay Frequency, Direct Deposit Amount; 1 row(s)) (table)');
  }
