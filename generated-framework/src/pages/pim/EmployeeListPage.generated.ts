...
export abstract class EmployeeListPageGenerated extends BasePage {
  ...
  readonly selectOpen = new EmployeeListPageSelectOpen(this.page);

  /** Elements revealed by opening 'Current Employees Only'. Open the trigger first. */
  readonly currentEmployeesOnlyOpen = new EmployeeListPageCurrentEmployeesOnlyOpen(this.page);

  /** Elements revealed by opening '-- Select --'. Open the trigger first. */
  readonly selectOpen2 = new EmployeeListPageSelectOpen2(this.page);

  /** Elements revealed by opening '-- Select --'. Open the trigger first. */
  readonly selectOpen3 = new EmployeeListPageSelectOpen3(this.page);
}

/** Only present while '-- Select --' is open. */
export class EmployeeListPageSelectOpen {
...
export class EmployeeListPageCurrentEmployeesOnlyOpen {
  constructor(private readonly page: Page) {}
...
/** Only present while '-- Select --' is open. */
export class EmployeeListPageSelectOpen2 {
  constructor(private readonly page: Page) {}
...
/** Only present while '-- Select --' is open. */
export class EmployeeListPageSelectOpen3 {
  constructor(private readonly page: Page) {}
