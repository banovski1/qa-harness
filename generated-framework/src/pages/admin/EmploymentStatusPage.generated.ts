...
// Source: web-index.php-admin-employmentStatus
...
export abstract class EmploymentStatusPageGenerated extends BasePage {
  ...
  get employmentStatusHeading(): TextComponent {
    return TextComponent.byHeading(this.page, 'Employment Status');
  }
  ...
  get recordsTable(): TableComponent {
    return new TableComponent(this.page.locator('.oxd-table:has(.oxd-table-th:text-is("Employment Status"))'), ['Employment Status', 'Actions'], 'Records (table)');
  }
}
