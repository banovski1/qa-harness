...
// Source: web-index.php-admin-registerOAuthClient
...
export abstract class RegisterOauthClientPageGenerated extends BasePage {
  ...
  /** OAuth Client List (text) */
  get oauthClientListHeading(): TextComponent {
    return TextComponent.byHeading(this.page, 'OAuth Client List');
  }
  ...
  get recordsTable(): TableComponent {
    return new TableComponent(this.page.locator('.oxd-table:has(.oxd-table-th:text-is("Name"))'), ['Name', 'Redirect URI', 'Status', 'Actions'], 'Records (table)');
  }
}
