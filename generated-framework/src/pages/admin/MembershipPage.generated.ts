...
// Source: web-index.php-admin-membership
...
export abstract class MembershipPageGenerated extends BasePage {
  ...
  /** Memberships (text) */
  get membershipsHeading(): TextComponent {
    return TextComponent.byHeading(this.page, 'Memberships');
  }
  ...
  get recordsTable(): TableComponent {
    return new TableComponent(this.page.locator('.oxd-table:has(.oxd-table-th:text-is("Membership"))'), ['Membership', 'Actions'], 'Records (table)');
  }
}
