...
// Source: web-index.php-admin-saveSystemUser
...
export abstract class SaveSystemUserPageGenerated extends BasePage {
  static readonly path = '/web/index.php/admin/saveSystemUser';
  ...
  /** Add User (text) */
  get addUserHeading(): TextComponent {
    return TextComponent.byHeading(this.page, 'Add User');
  }
