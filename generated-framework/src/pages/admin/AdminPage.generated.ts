...
// Source: web-index.php-admin-viewAdminModule
// Your own methods belong in AdminPage.ts, which the generator never touches.
...
export abstract class AdminPageGenerated extends BasePage {
  static readonly path = '/web/index.php/admin/viewAdminModule';

  constructor(page: Page) {
    super(page, AdminPageGenerated.path);
  }
  ...
  /** Table (, Username , User Role , Employee Name , Status , Actions; 2 row(s)) (table) */
  // UNSTABLE: table has no accessible name; positional index used
  get tableTable(): TableComponent {
    return new TableComponent(this.page.getByRole('table').nth(0), ['', 'Username ', 'User Role ', 'Employee Name ', 'Status ', 'Actions'], 'Table (, Username , User Role , Employee Name , Status , Actions; 2 row(s)) (table)');
  }
  ...
  readonly selectOpen = new AdminPageSelectOpen(this.page);

  /** Elements revealed by opening '-- Select --'. Open the trigger first. */
  readonly selectOpen2 = new AdminPageSelectOpen2(this.page);
}

/** Only present while '-- Select --' is open. */
export class AdminPageSelectOpen {
...
/** Only present while '-- Select --' is open. */
export class AdminPageSelectOpen2 {
  constructor(private readonly page: Page) {}
