...
// Source: web-index.php-admin-viewPayGrades
...
export abstract class PayGradesPageGenerated extends BasePage {
  ...
  /** Pay Grades (text) */
  get payGradesHeading(): TextComponent {
    return TextComponent.byHeading(this.page, 'Pay Grades');
  }
  ...
  get recordsTable(): TableComponent {
    return new TableComponent(this.page.locator('.oxd-table:has(.oxd-table-th:text-is("Name"))'), ['Name', 'Currency', 'Actions'], 'Records (table)');
  }
}
