...
// Source: web-index.php-admin-viewJobTitleList
...
export abstract class JobTitleListPageGenerated extends BasePage {
  ...
  /** Job Titles (text) */
  get jobTitlesHeading(): TextComponent {
    return TextComponent.byHeading(this.page, 'Job Titles');
  }
  ...
  get recordsTable(): TableComponent {
    return new TableComponent(this.page.locator('.oxd-table:has(.oxd-table-th:text-is("Job Titles"))'), ['Job Titles', 'Job Description', 'Actions'], 'Records (table)');
  }
}
