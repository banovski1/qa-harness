...
// Source: web-index.php-admin-viewLocations
...
export abstract class LocationsPageGenerated extends BasePage {
  ...
  /** Locations (text) */
  get locationsHeading(): TextComponent {
    return TextComponent.byHeading(this.page, 'Locations');
  }
  ...
  get recordsTable(): TableComponent {
    return new TableComponent(this.page.locator('.oxd-table:has(.oxd-table-th:text-is("Name"))'), ['Name', 'City', 'Country', 'Phone', 'Number of Employees', 'Actions'], 'Records (table)');
  }
}
