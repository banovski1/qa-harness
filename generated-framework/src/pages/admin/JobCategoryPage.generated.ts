...
// Source: web-index.php-admin-jobCategory
...
export abstract class JobCategoryPageGenerated extends BasePage {
  ...
  /** Job Categories (text) */
  get jobCategoriesHeading(): TextComponent {
    return TextComponent.byHeading(this.page, 'Job Categories');
  }
  ...
  get recordsTable(): TableComponent {
    return new TableComponent(this.page.locator('.oxd-table:has(.oxd-table-th:text-is("Job Category"))'), ['Job Category', 'Actions'], 'Records (table)');
  }
}
