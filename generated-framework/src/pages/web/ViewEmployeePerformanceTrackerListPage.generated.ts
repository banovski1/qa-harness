...
export class ViewEmployeePerformanceTrackerListPageGenerated extends BasePage {
  readonly path = '/web/index.php/performance/viewEmployeePerformanceTrackerList';
