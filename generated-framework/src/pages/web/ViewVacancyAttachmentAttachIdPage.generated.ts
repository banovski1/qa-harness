...
export class ViewVacancyAttachmentAttachIdPageGenerated extends BasePage {
  readonly path = '/web/index.php/recruitment/viewVacancyAttachment/attachId/{attachId}';
