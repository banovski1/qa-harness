...
export class WebIndexPhpMaintenanceAccessEmployeeData2PageGenerated extends BasePage {
  readonly path = '/web/index.php/maintenance/accessEmployeeData/{empNumber}';
