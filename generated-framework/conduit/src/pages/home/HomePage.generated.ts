...
export class HomePageGenerated extends BasePage {
  ...
  readonly control1 = new Button(this.page, { label: '1', within: 'React Hooks: Best Practices and Common Pitfalls' }, { screen: 'HomePage', expectedUrl: '/', modelPath: MODEL_PATH });
  ...
  readonly control12 = new Button(this.page, { label: '1', within: 'Building Scalable APIs with Node.js' }, { screen: 'HomePage', expectedUrl: '/', modelPath: MODEL_PATH });
  ...
  readonly control13 = new Button(this.page, { label: '1', within: 'Introduction to Machine Learning for Developers' }, { screen: 'HomePage', expectedUrl: '/', modelPath: MODEL_PATH });
