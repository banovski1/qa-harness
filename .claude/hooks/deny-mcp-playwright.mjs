...
process.stderr.write(
  [
    ...
    'it replaces these tools and costs a fraction of the tokens. To build or refresh the',
    'application map, use the smart-map skill instead of driving the browser directly.',
  ].join('\n') + '\n',
);
process.exit(2);
